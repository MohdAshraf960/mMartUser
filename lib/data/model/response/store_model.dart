...
class Store {
  ...
  @override
  String toString() {
    return 'Store(id: $id, name: $name, phone: $phone, email: $email, logo: $logo, latitude: $latitude, longitude: $longitude, address: $address, minimumOrder: $minimumOrder, currency: $currency, freeDelivery: $freeDelivery, coverPhoto: $coverPhoto, delivery: $delivery, takeAway: $takeAway, scheduleOrder: $scheduleOrder, avgRating: $avgRating, tax: $tax, ratingCount: $ratingCount, featured: $featured, zoneId: $zoneId, selfDeliverySystem: $selfDeliverySystem, posSystem: $posSystem, minimumShippingCharge: $minimumShippingCharge, perKmShippingCharge: $perKmShippingCharge, open: $open, active: $active, deliveryTime: $deliveryTime, categoryIds: $categoryIds, veg: $veg, nonVeg: $nonVeg, moduleId: $moduleId, orderPlaceToScheduleInterval: $orderPlaceToScheduleInterval, discount: $discount, schedules: $schedules, vendorId: $vendorId, prescriptionOrder: $prescriptionOrder)';
  }
}
