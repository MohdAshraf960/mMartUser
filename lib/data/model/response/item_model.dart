...
class Item {
  ...
  @override
  String toString() {
    return 'Item(id: $id, name: $name, description: $description, image: $image, images: $images, categoryId: $categoryId, categoryIds: $categoryIds, variations: $variations, foodVariations: $foodVariations, addOns: $addOns, choiceOptions: $choiceOptions, price: $price, tax: $tax, discount: $discount, discountType: $discountType, availableTimeStarts: $availableTimeStarts, availableTimeEnds: $availableTimeEnds, storeId: $storeId, storeName: $storeName, zoneId: $zoneId, storeDiscount: $storeDiscount, scheduleOrder: $scheduleOrder, avgRating: $avgRating, ratingCount: $ratingCount, veg: $veg, moduleId: $moduleId, moduleType: $moduleType, unitType: $unitType, stock: $stock, availableDateStarts: $availableDateStarts)';
  }
}
