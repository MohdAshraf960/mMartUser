...
class ConfigModel {
  ...
  @override
  String toString() {
    return 'ConfigModel(businessName: $businessName, logo: $logo, address: $address, phone: $phone, email: $email, baseUrls: $baseUrls, country: $country, defaultLocation: $defaultLocation, currencySymbol: $currencySymbol, currencySymbolDirection: $currencySymbolDirection, appMinimumVersionAndroid: $appMinimumVersionAndroid, appUrlAndroid: $appUrlAndroid, appMinimumVersionIos: $appMinimumVersionIos, appUrlIos: $appUrlIos, customerVerification: $customerVerification, scheduleOrder: $scheduleOrder, orderDeliveryVerification: $orderDeliveryVerification, cashOnDelivery: $cashOnDelivery, digitalPayment: $digitalPayment, perKmShippingCharge: $perKmShippingCharge, minimumShippingCharge: $minimumShippingCharge, freeDeliveryOver: $freeDeliveryOver, demo: $demo, maintenanceMode: $maintenanceMode, orderConfirmationModel: $orderConfirmationModel, showDmEarning: $showDmEarning, canceledByDeliveryman: $canceledByDeliveryman, timeformat: $timeformat, language: $language, toggleVegNonVeg: $toggleVegNonVeg, toggleDmRegistration: $toggleDmRegistration, toggleStoreRegistration: $toggleStoreRegistration, scheduleOrderSlotDuration: $scheduleOrderSlotDuration, digitAfterDecimalPoint: $digitAfterDecimalPoint, parcelPerKmShippingCharge: $parcelPerKmShippingCharge, parcelMinimumShippingCharge: $parcelMinimumShippingCharge, module: $module, moduleConfig: $moduleConfig, landingPageSettings: $landingPageSettings, socialMedia: $socialMedia, footerText: $footerText, landingPageLinks: $landingPageLinks, loyaltyPointExchangeRate: $loyaltyPointExchangeRate, loyaltyPointItemPurchasePoint: $loyaltyPointItemPurchasePoint, loyaltyPointStatus: $loyaltyPointStatus, minimumPointToTransfer: $minimumPointToTransfer, customerWalletStatus: $customerWalletStatus, dmTipsStatus: $dmTipsStatus, refEarningStatus: $refEarningStatus, refEarningExchangeRate: $refEarningExchangeRate, socialLogin: $socialLogin, refundActiveStatus: $refundActiveStatus, refundPolicyStatus: $refundPolicyStatus, cancellationPolicyStatus: $cancellationPolicyStatus, shippingPolicyStatus: $shippingPolicyStatus, prescriptionStatus: $prescriptionStatus, taxIncluded: $taxIncluded)';
  }
}
...
class Module {
  ...
  @override
  String toString() {
    return 'Module(orderPlaceToScheduleInterval: $orderPlaceToScheduleInterval, addOn: $addOn, stock: $stock, vegNonVeg: $vegNonVeg, unit: $unit, orderAttachment: $orderAttachment, showRestaurantText: $showRestaurantText, isParcel: $isParcel, newVariation: $newVariation, description: $description)';
  }
}
