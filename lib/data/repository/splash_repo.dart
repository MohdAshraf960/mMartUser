...
class SplashRepo {
  ...
  Future<void> setCacheModule(ModuleModel module) async {
    if (module != null) {
      await sharedPreferences.setString(
          AppConstants.CACHE_MODULE_ID, jsonEncode(module.toJson()));
    } else {
  ...
  ModuleModel getCacheModule() {
    ...
    if (sharedPreferences.containsKey(AppConstants.CACHE_MODULE_ID)) {
      try {
        _module = ModuleModel.fromJson(jsonDecode(
            sharedPreferences.getString(AppConstants.CACHE_MODULE_ID)));
      } catch (e) {}
    }
    return _module;
  }
      ...
      htmlType == HtmlType.TERMS_AND_CONDITION
          ...
          : htmlType == HtmlType.PRIVACY_POLICY
              ...
              : htmlType == HtmlType.ABOUT_US
                  ...
                  : htmlType == HtmlType.SHIPPING_POLICY
                      ? AppConstants.SHIPPING_POLICY_URI
                      : htmlType == HtmlType.CANCELATION
                          ? AppConstants.CANCELATION_URI
                          : AppConstants.REFUND_URI,
      headers: {
