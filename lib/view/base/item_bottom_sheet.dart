            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
              ...
              Padding(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          : GetBuilder<WishListController>(builder: (wishList) {
                              return InkWell(
                                onTap: () {
                                  if (Get.find<AuthController>().isLoggedIn()) {
                                    wishList.wishItemIdList.contains(widget.item.id)
                                        ? wishList.removeFromWishList(widget.item.id, false, getXSnackBar: true)
                                ...
                                child: Icon(
                                  ...
                                  color: wishList.wishItemIdList.contains(widget.item.id) ? Theme.of(context).primaryColor : Theme.of(context).disabledColor,
                                ),
                              );
                            }),
                    ]),
                  ...
                  // Addons
                  (Get.find<SplashController>().configModel.moduleConfig.module.addOn && widget.item.addOns.length > 0)
                      ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
