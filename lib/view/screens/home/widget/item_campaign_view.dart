...
class ItemCampaignView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CampaignController>(builder: (campaignController) {
      return (campaignController.itemCampaignList != null && campaignController.itemCampaignList.length == 0)
          ? SizedBox()
          : Column(
              children: [
                Padding(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                    Stack(children: [
                                      ...
                                      DiscountTag(
                                        ...
                                        discountType:
                                            campaignController.itemCampaignList[index].storeDiscount > 0 ? 'percent' : campaignController.itemCampaignList[index].discountType,
                                      ),
                                      Get.find<ItemController>().isAvailable(campaignController.itemCampaignList[index]) ? SizedBox() : NotAvailableWidget(),
                                    ]),
                                    Expanded(
                                      child: Padding(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          decoration: BoxDecoration(
              color: Colors.white, borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL), boxShadow: [BoxShadow(color: Colors.grey[300], blurRadius: 10, spreadRadius: 1)]),
          child: Shimmer(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                height: 90,
                width: 130,
                decoration: BoxDecoration(borderRadius: BorderRadius.vertical(top: Radius.circular(Dimensions.RADIUS_SMALL)), color: Colors.grey[300]),
              ),
              Expanded(
                child: Padding(
