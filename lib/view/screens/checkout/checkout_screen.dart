              ...
              return GetBuilder<StoreController>(builder: (storeController) {
                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (orderController.orderType == 'Pickup' ||
                        (storeController.store != null &&
                                ...
                                child: FooterView(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        orderController.orderType != 'Pickup'
                                            ? Column(
                                                crossAxisAlignment:
                                                    CrossAxisAlignment.start,
                                                children: [
  ...
  void _callback(bool isSuccess, String message, String orderID, int zoneID,
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 1) {
        ...
        Get.offNamed(
            RouteHelper.getOrderSuccessRoute(orderID, _isCashOnDeliveryActive));
      }
                      ...
                      if (!_isCashOnDeliveryActive &&
                        ...
                        showCustomSnackBar(
                            'one_or_more_products_are_not_available_for_this_selected_time'
                                .tr);
                      } else if (orderController.orderType != 'Pickup' &&
                          orderController.distance == -1 &&
                          deliveryCharge == -1) {
